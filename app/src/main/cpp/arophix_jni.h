...
#ifndef JNIEXAMPLE_AROPHIX_JNI_H
#define JNIEXAMPLE_AROPHIX_JNI_H
...
extern JavaVM* g_jvm;
extern jclass g_aroStorageClazz;
extern jobject g_aroStorageObj;
...
#endif //JNIEXAMPLE_AROPHIX_JNI_H
